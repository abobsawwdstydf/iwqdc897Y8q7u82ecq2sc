                ...
                <div className="p-4">
                    <div className="relative mb-4">
                        ...
                        <input
                            ...
                            className="w-full bg-black/20 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-white placeholder-zinc-500 focus:outline-none focus:border-Nimbus-500 transition-colors"
                        />
                    </div>
