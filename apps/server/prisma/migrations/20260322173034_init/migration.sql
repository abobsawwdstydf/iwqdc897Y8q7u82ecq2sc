...
CREATE TABLE "ChatAvatar" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "ChatAvatar_chatId_fkey" FOREIGN KEY ("chatId") REFERENCES "Chat" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "LiveStream" (
    ...
    "endedAt" DATETIME,
    "title" TEXT,
    CONSTRAINT "LiveStream_chatId_fkey" FOREIGN KEY ("chatId") REFERENCES "Chat" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "LiveStream_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ChatAvatar_chatId_position_key" ON "ChatAvatar"("chatId", "position");
