...
>
> It serves the same purpose (you do not need to require and load dotenv), adds better debugging, and works with ANY language, framework, or platform. вЂ“ [motdotla](https://mot.la)
...
> El software estГЎ cambiando, y dotenv debe cambiar con Г©lвЂ”por eso construГ­ [agentic secret storage (AS2)](https://dotenvx.com/as2). Los agentes ejecutan cГіdigo sin humanos en la terminal, por lo que los archivos `.env` en texto plano son el primitivo equivocado.
>
> AS2 estГЎ diseГ±ado para software autГіnomo: cifrado por defecto, cero acceso a consola y entrega priorizando la criptografГ­a que mantiene a los operadores fuera del circuito.
>
> EstГЎ respaldado por [Vestauth](https://github.com/vestauth/vestauth), la capa de autenticaciГіn pionera y de confianza para agentesвЂ”que otorga a cada agente una identidad criptogrГЎfica para firmar solicitudes con claves privadas y verificarlas con claves pГєblicas. Sin secretos compartidos que se filtren.
>
...
ВЎEso es todo! Este nuevo primitivo habilita el acceso a secretos para agentes sin intervenciГіn humana, flujos de OAuth ni claves API. Es el futuro para los agentes.
...
> In a twelve-factor app, env vars are granular controls, each fully orthogonal to other env vars. They are never grouped together as вЂњenvironmentsвЂќ, but instead are independently managed for each deploy. This is a model that scales up smoothly as the app naturally expands into more deploys over its lifetime.
>
> вЂ“ [The Twelve-Factor App](http://12factor.net/config)
...
>
> вЂ“ [ES6 In Depth: Modules](https://hacks.mozilla.org/2015/08/es6-in-depth-modules/)
