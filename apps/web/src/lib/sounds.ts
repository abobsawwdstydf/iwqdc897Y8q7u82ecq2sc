...
// Call ended/declined sound
export function playCallEndedSound() {
  try {
    const audio = new Audio('/sounds/cal_sound_ds.mp3');
    audio.volume = 0.7;
    audio.play().catch(() => {});
  } catch (e) {
    // silent fail
...
// User joined call sound
export function playUserJoinSound() {
  try {
    const audio = new Audio('/sounds/user_join.mp3');
    audio.volume = 0.7;
    audio.play().catch(() => {});
  } catch (e) {
    // silent fail
...
// User left call sound
export function playUserLeaveSound() {
  try {
    const audio = new Audio('/sounds/user_leave.mp3');
    audio.volume = 0.7;
    audio.play().catch(() => {});
  } catch (e) {
    // silent fail
