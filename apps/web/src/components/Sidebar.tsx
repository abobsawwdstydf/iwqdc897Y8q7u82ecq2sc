...
export default function Sidebar({ onChatSelect }: SidebarProps) {
  ...
  return (
    <>
      <div className="w-full lg:w-[340px] h-full flex flex-col bg-surface-secondary rounded-3xl overflow-hidden border border-border/50 shadow-2xl relative z-10">
        {/* РЁР°РїРєР° */}
