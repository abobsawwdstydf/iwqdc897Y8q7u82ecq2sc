...
export declare class Socket<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ListenEvents, EmitEvents, SocketReservedEventsMap> {
     ...
     * @example
     * io.on("connection", (socket) => {
     *   // the вЂњfooвЂќ event will be broadcast to all connected clients in the вЂњroom-101вЂќ room, except this socket
     ...
     * receive messages (because of network slowness or other issues, or because theyвЂ™re connected through long polling
     ...
     * @example
     * io.on("connection", (socket) => {
     *   // the вЂњfooвЂќ event will be broadcast to all connected clients, except this socket
     ...
     * @example
     * io.on("connection", (socket) => {
     *   // the вЂњfooвЂќ event will be broadcast to all connected clients on this node, except this socket
