...
export declare class BroadcastOperator<EmitEvents extends EventsMap, SocketData> implements TypedEventBroadcaster<EmitEvents> {
     ...
     *
     * @example
     * // the вЂњfooвЂќ event will be broadcast to all connected clients in the вЂњroom-101вЂќ room
     ...
     *
     * @example
     * // the вЂњfooвЂќ event will be broadcast to all connected clients on this node
     ...
     *
     * @example
     * // the вЂњfooвЂќ event will be broadcast to all connected clients
     * io.emit("foo", "bar");
     *
     * // the вЂњfooвЂќ event will be broadcast to all connected clients in the вЂњroom-101вЂќ room
     * io.to("room-101").emit("foo", "bar");
