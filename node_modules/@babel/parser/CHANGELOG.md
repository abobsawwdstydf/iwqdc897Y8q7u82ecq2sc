...
Disallow import type { type a } from вЂ¦ ([#305](https://github.com/babel/babylon/pull/305)) (Daniel Tschinder)
...
Update eslint-config-babel to the latest version рџљЂ ([#299](https://github.com/babel/babylon/pull/299)) (greenkeeper[bot])

Update eslint-config-babel to the latest version рџљЂ ([#293](https://github.com/babel/babylon/pull/293)) (greenkeeper[bot])
...
When high value unicode entities (e.g. рџ’©) were used in the input source code they are now correctly encoded in the resulting AST.
...
Update eslint-config-babel to the latest version рџљЂ ([#273](https://github.com/babel/babylon/pull/273)) (greenkeeper[bot])
...
Parse flow nested array type annotations like `number[][]` ([#219](https://github.com/babel/babylon/pull/219)) (Bernhard HГ¤ussner)
