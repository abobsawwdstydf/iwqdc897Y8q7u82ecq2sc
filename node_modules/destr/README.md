...
### вњ… Fast fallback to input if is not string
...
### вњ… Fast lookup for known string values
...
### вњ… Fallback to original value if parse fails (empty or any plain string)
