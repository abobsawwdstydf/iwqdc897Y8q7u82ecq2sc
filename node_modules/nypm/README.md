...
рџЊ€ Unified Package Manager for Node.js (npm, pnpm, yarn), Bun and Deno.

вњ… Supports [npm](https://docs.npmjs.com/cli/v10/commands/npm), [yarn](https://yarnpkg.com/), [pnpm](https://pnpm.io/), [bun](https://bun.sh/package-manager) and [deno](https://deno.com/) out of the box with a unified API.

вњ… Provides an **API interface** to interact with package managers.

вњ… **Autodetects** project's package manager using `package.json` and known lockfiles.

вњ… **[corepack](https://github.com/nodejs/corepack)** integration for **pnpm** and **yarn**.
