...
export interface StandardLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2015.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since March 2022.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2021.
   *
   * **Syntax**: `auto || <ratio>`
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `<attachment>#`
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since January 2020.
   *
   * **Syntax**: `<blend-mode>#`
   *
   * **Initial value**: `normal`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2016.
   *
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `<length-percentage [0,в€ћ]>{1,2}`
   *
   * **Initial value**: `0`
   *
   * | Chrome  | Firefox | Safari  |  Edge  |  IE   |
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `[ <length [0,в€ћ]> | <number [0,в€ћ]> ]{1,4}  `
   *
   * **Initial value**: `0`
   *
   * | Chrome | Firefox | Safari |  Edge  |   IE   |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since March 2016.
   *
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `[ <number [0,в€ћ]> | <percentage [0,в€ћ]> ]{1,4}  && fill?`
   *
   * **Initial value**: `100%`
   *
   * | Chrome | Firefox | Safari |  Edge  |   IE   |
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `[ <length-percentage [0,в€ћ]> | <number [0,в€ћ]> | auto ]{1,4}`
   *
   * **Initial value**: `1`
   *
   * | Chrome | Firefox | Safari |  Edge  |   IE   |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since January 2019.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since January 2022.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since March 2017.
   *
   * **Syntax**: `<integer> | auto`
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2020.
   *
   * **Syntax**: `none | all`
   *
   * **Initial value**: `none`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since November 2016.
   *
   * **Syntax**: `<length> | auto`
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since February 2023.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since December 2021.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since April 2017.
   *
   * **Syntax**: `<paint>`
   *
   * **Initial value**: `black`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since March 2020.
   *
   * **Syntax**: `auto | none`
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since November 2022.
   *
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `<absolute-size> | <relative-size> | <length-percentage [0,в€ћ]> | math`
   *
   * **Initial value**: `medium`
   *
   * | Chrome | Firefox | Safari |  Edge  |   IE    |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since March 2023.
   *
   * **Syntax**: `auto | none`
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2018.
   *
  ...
  /**
   * **Syntax**: `normal | <percentage [0,в€ћ]> | ultra-condensed | extra-condensed | condensed | semi-condensed | semi-expanded | expanded | extra-expanded | ultra-expanded`
   *
   * **Initial value**: `normal`
   *
   * | Chrome | Firefox |  Safari  | Edge | IE  |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since October 2017.
   *
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `auto | <length-percentage [0,в€ћ]> | min-content | max-content | fit-content | fit-content(<length-percentage [0,в€ћ]>) | <calc-size()> | <anchor-size()>`
   *
   * **Initial value**: `auto`
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since April 2020.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since April 2021.
   *
   * **Syntax**: `<'top'>`
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2016.
   *
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `none | <length-percentage [0,в€ћ]> | min-content | max-content | fit-content | fit-content(<length-percentage [0,в€ћ]>) | <calc-size()> | <anchor-size()>`
   *
   * **Initial value**: `none`
   *
   * | Chrome | Firefox | Safari  |  Edge  |  IE   |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2022.
   *
   * **Syntax**: `<length-percentage>`
   *
   * **Initial value**: `0`
   ...
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   * **Syntax**: `<visual-box> || <length [0,в€ћ]>`
   *
   * **Initial value**: `0px`
   *
   * | Chrome | Firefox | Safari |  Edge  | IE  |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since October 2018.
   *
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `<length-percentage [0,в€ћ]>`
   *
   * **Initial value**: `0`
   *
   * | Chrome | Firefox | Safari |  Edge  |  IE   |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since August 2022.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2022.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since April 2022.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since August 2021.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since August 2016.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since March 2021.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2020.
   *
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since November 2020.
   *
   * **Syntax**: `auto | <length> | <percentage> `
   *
   * **Initial value**: `auto`
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since September 2019.
   *
   ...
   *
   * **Syntax**: `normal | reset | <number [0,в€ћ]> || <percentage [0,в€ћ]>`
   *
   * **Initial value**: `1`
   *
   * | Chrome | Firefox | Safari  |  Edge  |   IE    |
...
export interface StandardShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2015.
   *
   * **Syntax**: `<length-percentage [0,в€ћ]>{1,4} [ / <length-percentage [0,в€ћ]>{1,4} ]?`
   *
   * | Chrome  | Firefox | Safari  |  Edge  |  IE   |
   * | :-----: | :-----: | :-----: | :----: | :---: |
   * |  **4**  |  **4**  |  **5**  | **12** | **9** |
  ...
  /**
   * This feature is well established and works across many devices and browser versions. ItвЂ™s been available across browsers since July 2021.
   *
   * **Syntax**: `<length>{1,4}`
   *
   * | Chrome | Firefox |          Safari           |  Edge  | IE  |
...
export interface ObsoleteProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`clip`** CSS property defines a visible portion of an element. The `clip` property applies only to absolutely positioned elements вЂ” that is, elements with `position:absolute` or `position:fixed`.
   *
   * **Syntax**: `<shape> | auto`
   *
   * **Initial value**: `auto`
