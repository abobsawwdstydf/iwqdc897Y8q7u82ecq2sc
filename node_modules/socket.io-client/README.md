...
In order to see all the client debug output, run the following command on the browser console вЂ“ including the desired scope вЂ“ and reload your app page:
