...
```
Caller Application в†’ qs.parse(input, options) в†’ Parsing Engine в†’ Output Object
                           в”‚
                           в””в†’ Options Handling

Caller Application в†’ qs.stringify(obj, options) в†’ Stringifying Engine в†’ Output String
                           в”‚
                           в””в†’ Options Handling
                           в””в†’ Cycle Tracking
```
...
|---------------------------------------|----|----|----|----|----|----|
| Public API Call (`parse`)             | вЂ“  | вњ“  | вЂ“  | вњ“  | вњ“  | вњ“  |
| Public API Call (`stringify`)         | вЂ“  | вњ“  | вЂ“  | вњ“  | вњ“  | вЂ“  |
| Options Handling                      | вњ“  | вњ“  | вЂ“  | вњ“  | вЂ“  | вњ“  |
| Dependency Interaction                | вЂ“  | вЂ“  | вЂ“  | вЂ“  | вњ“  | вЂ“  |
