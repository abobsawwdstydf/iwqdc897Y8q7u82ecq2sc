...
declare namespace React {
    ...
    /**
     * Lets you defer loading a componentвЂ™s code until it is rendered for the first time.
     *
     ...
     * resolved valueвЂ™s `.default` as a React component. Both the returned `Promise` and the `Promise`вЂ™s
     ...
     *
     * Note that `useRef()` is useful for more than the `ref` attribute. ItвЂ™s handy for keeping any mutable
     * value around similar to how youвЂ™d use instance fields in classes.
     *
     * @version 16.8.0
     ...
     *
     * If youвЂ™re migrating code from a class component, `useLayoutEffect` fires in the same phase as
     ...
     *
     * NOTE: We donвЂ™t recommend adding debug values to every custom hook.
     * ItвЂ™s most valuable for custom hooks that are part of shared libraries.
     *
     * @version 16.8.0
    ...
    /**
     * Returns a deferred version of the value that may вЂњlag behindвЂќ it.
     *
     ...
     * @param initialValue A value to use during the initial render of a component. If this option is omitted, `useDeferredValue` will not defer during the initial render, because thereвЂ™s no previous version of `value` that it can render instead.
     *
     ...
     *
     * The first is a boolean, ReactвЂ™s way of informing us whether weвЂ™re waiting for the transition to finish.
