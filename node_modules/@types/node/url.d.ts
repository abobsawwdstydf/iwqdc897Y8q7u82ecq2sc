...
declare module "url" {
     ...
     * import url from 'node:url';
     *
     * console.log(url.domainToASCII('espaГ±ol.com'));
     * // Prints xn--espaol-zwa.com
     * console.log(url.domainToASCII('дё­ж–‡.com'));
     * // Prints xn--fiq228c.com
     * console.log(url.domainToASCII('xn--iГ±valid.com'));
     ...
     * // Prints дё­ж–‡.com
     * console.log(url.domainToUnicode('xn--iГ±valid.com'));
     * // Prints an empty string
     * ```
     * @since v7.4.0, v6.13.0
     */
     ...
     *
     * new URL('file:///дЅ еҐЅ.txt').pathname;      // Incorrect: /%E4%BD%A0%E5%A5%BD.txt
     * fileURLToPath('file:///дЅ еҐЅ.txt');         // Correct:   /дЅ еҐЅ.txt (POSIX)
     *
     ...
     * const myURL = new URL('https://a:b@жё¬и©¦?abc#foo');
     *
    ...
    class URL {
         ...
         *
         * ```js
         * const idnURL = new URL('https://жё¬и©¦');
