...
declare module "inspector" {
    ...
    namespace NetworkResources {
         ...
         * This is typically triggered when a source map is specified by URL, and a DevTools frontendвЂ”such as
         * ChromeвЂ”requests the resource to retrieve the source map.
         *
