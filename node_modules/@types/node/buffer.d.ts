 ...
 *
 * // Creates a Buffer containing the bytes [1, 1, 1, 1] вЂ“ the entries
 * // are all truncated using `(value &#x26; 255)` to fit into the range 0вЂ“255.
 * const buf5 = Buffer.from([257, 257.5, -255, '1']);
 *
 * // Creates a Buffer containing the UTF-8-encoded bytes for the string 'tГ©st':
 * // [0x74, 0xc3, 0xa9, 0x73, 0x74] (in hexadecimal notation)
 * // [116, 195, 169, 115, 116] (in decimal notation)
 * const buf6 = Buffer.from('tГ©st');
 *
 * // Creates a Buffer containing the Latin-1 bytes [0x74, 0xe9, 0x73, 0x74].
 * const buf7 = Buffer.from('tГ©st', 'latin1');
 * ```
...
declare module "buffer" {
     ...
     *
     * const newBuf = transcode(Buffer.from('в‚¬'), 'utf8', 'ascii');
     * console.log(newBuf.toString('ascii'));
     * // Prints: '?'
     * ```
     *
     * Because the Euro (`в‚¬`) sign is not representable in US-ASCII, it is replaced
    ...
    global {
        ...
        interface BufferConstructor {
             ...
             * // Prints: ВЅ + Вј = Вѕ: 9 characters, 12 bytes
             * ```
             *
             * When `string` is a
