...
export interface GeneratorOptions {
    ...
    /**
     * Set to true to run jsesc with "json": true to print "\u00A9" vs. "В©";
     */
    ...
    jsescOption?: {
         ...
         * environments is a concern, donвЂ™t enable this setting. If the json setting is enabled, the value for the es6
         ...
         * enabled, all the symbols in the output are escaped вЂ” even printable ASCII symbols.
         */
         ...
         * is escaped as \x3C!-- (or \u003C!-- when the json option is enabled). This setting is useful when jsescвЂ™s
         ...
         * the output for arrays and objects is as compact as possible; itвЂ™s not formatted nicely.
         */
         ...
         * overridden if needed вЂ” but in such cases, the output wonвЂ™t be valid JSON anymore.
         */
