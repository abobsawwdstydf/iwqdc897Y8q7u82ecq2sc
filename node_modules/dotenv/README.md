<div align="center">
рџЋ‰ announcing <a href="https://github.com/dotenvx/dotenvx">dotenvx</a>. <em>run anywhere, multi-environment, encrypted envs</em>.
</div>
...
* [рџЊ± Install](#-install)
* [рџЏ—пёЏ Usage (.env)](#%EF%B8%8F-usage)
* [рџЊґ Multiple Environments рџ†•](#-manage-multiple-environments)
* [рџљЂ Deploying (encryption) рџ†•](#-deploying)
* [рџ“љ Examples](#-examples)
* [рџ“– Docs](#-documentation)
* [вќ“ FAQ](#-faq)
* [вЏ±пёЏ Changelog](./CHANGELOG.md)
...
>
> It serves the same purpose (you do not need to require and load dotenv), adds better debugging, and works with ANY language, framework, or platform. вЂ“ [motdotla](https://github.com/motdotla)
...
## рџЊґ Manage Multiple Environments
