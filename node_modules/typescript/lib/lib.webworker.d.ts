...
/**
 * The **`DOMMatrix`** interface represents 4Г—4 matrices, suitable for 2D and 3D operations including rotation and translation.
 *
...
interface DOMMatrix extends DOMMatrixReadOnly {
    ...
    /**
     * The **`multiplySelf()`** method of the DOMMatrix interface multiplies a matrix by the `otherMatrix` parameter, computing the dot product of the original matrix and the specified matrix: `Aв‹…B`.
     *
...
/**
 * The **`DOMMatrixReadOnly`** interface represents a read-only 4Г—4 matrix, suitable for 2D and 3D operations.
 *
...
/**
 * The **`ExtendableMessageEvent`** interface of the Service Worker API represents the event object of a ServiceWorkerGlobalScope/message_event event fired on a service worker (when a message is received on the ServiceWorkerGlobalScope from another context) вЂ” extends the lifetime of such events.
 *
...
interface WebTransport {
    ...
    /**
     * The **`datagrams`** read-only property of the WebTransport interface returns a WebTransportDatagramDuplexStream instance that can be used to send and receive datagrams вЂ” unreliable data transmission.
     *
...
interface WebTransportDatagramDuplexStream {
    /**
     * The **`incomingHighWaterMark`** property of the WebTransportDatagramDuplexStream interface gets or sets the high water mark for incoming chunks of data вЂ” this is the maximum size, in chunks, that the incoming ReadableStream's internal queue can reach before it is considered full.
     *
    ...
    /**
     * The **`outgoingHighWaterMark`** property of the WebTransportDatagramDuplexStream interface gets or sets the high water mark for outgoing chunks of data вЂ” this is the maximum size, in chunks, that the outgoing WritableStream's internal queue can reach before it is considered full.
     *
