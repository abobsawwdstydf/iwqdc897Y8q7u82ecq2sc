...
- [New] ensure an ErrorвЂ™s `cause` is displayed [`53bc2ce`](https://github.com/inspect-js/object-inspect/commit/53bc2cee4e5a9cc4986f3cafa22c0685f340715e)
...
- [New] add enumerable properties to Function inspect result, per nodeвЂ™s `assert` [`fd38e1b`](https://github.com/inspect-js/object-inspect/commit/fd38e1bc3e2a1dc82091ce3e021917462eee64fc)
...
- [Fix] do not be fooled by a functionвЂ™s own `toString` method [`7cb5c65`](https://github.com/inspect-js/object-inspect/commit/7cb5c657a976f94715c19c10556a30f15bb7d5d7)
...
- [Tests] move `0.6` to allowed failures, because it wonвЂt build on travis [`1bff32a`](https://github.com/inspect-js/object-inspect/commit/1bff32aa52e8aea687f0856b28ba754b3e43ebf7)
...
- [Fix] `inspect(Object(-0))` should be вЂњObject(-0)вЂќ, not вЂњObject(0)вЂќ [`d0a031f`](https://github.com/inspect-js/object-inspect/commit/d0a031f1cbb3024ee9982bfe364dd18a7e4d1bd3)
...
- [Tests] up to `node` `v8.6`; use `nvm install-latest-npm` to ensure new npm doesnвЂ™t break old node [`252952d`](https://github.com/inspect-js/object-inspect/commit/252952d230d8065851dd3d4d5fe8398aae068529)
