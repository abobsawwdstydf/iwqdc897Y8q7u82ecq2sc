...
export type UniqueArraySharedConstraints = {
     ...
     * @defaultValue 0x7fffffff вЂ” _defaulting seen as "max non specified" when `defaultSizeToMaxWhenMaxSpecified=true`_
     * @remarks Since 2.23.0
     */
    maxLength?: number;
    /**
...
export type UniqueArrayConstraintsRecommended<T, U> = UniqueArraySharedConstraints & {
     ...
     * - SameValue behaves like `Object.is` вЂ” {@link https://tc39.es/ecma262/multipage/abstract-operations.html#sec-samevalue}
     * - SameValueZero behaves like `Set` or `Map` вЂ” {@link https://tc39.es/ecma262/multipage/abstract-operations.html#sec-samevaluezero}
     * - IsStrictlyEqual behaves like `===` вЂ” {@link https://tc39.es/ecma262/multipage/abstract-operations.html#sec-isstrictlyequal}
