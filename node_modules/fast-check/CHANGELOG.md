...
- ([PR#3113](https://github.com/dubzzz/fast-check/pull/3113)) CI: Consider вљЎпёЏ aka zap PRs as fixes for changelog
...
- ([PR#2935](https://github.com/dubzzz/fast-check/pull/2935)) Drop support for TypeScript 3.2 (min в‰Ґ4.1)
