...
export default class MagicString {
	 ...
	 *
	 * The fourth argument is optional. It can have a storeName property вЂ” if true, the original name will be stored
	 * for later inclusion in a sourcemap's names array вЂ” and a contentOnly property which determines whether only
	 ...
	 *
	 * The fourth argument is optional. It can have a storeName property вЂ” if true, the original name will be stored
	 * for later inclusion in a sourcemap's names array вЂ” and an overwrite property which determines whether only
	 * the content is overwritten, or anything that was appended/prepended to the range as well.
	 */
