...
declare abstract class Node_ {
   ...
   * * `left`: the space symbols between `/*` and the commentвЂ™s text.
   * * `right`: the space symbols between the commentвЂ™s text
   *   and <code>*&#47;</code>.
  ...
  /**
   * Insert new node after current node to current nodeвЂ™s parent.
   *
  ...
  /**
   * Insert new node before current node to current nodeвЂ™s parent.
   *
  ...
  /**
   * Returns the next child of the nodeвЂ™s parent.
   ...
   *
   * @param index The symbol number in the nodeвЂ™s string.
   * @return Symbol position in file.
   */
  positionInside(index: number): Node.Position

  /**
   * Returns the previous child of the nodeвЂ™s parent.
  ...
  /**
   * Finds the Root instance of the nodeвЂ™s tree.
   *
   * ```js
