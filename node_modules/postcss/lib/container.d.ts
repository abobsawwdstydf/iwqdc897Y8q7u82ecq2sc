...
declare namespace Container {
  ...
  export interface ValueOptions {
    /**
     * String thatвЂ™s used to narrow down values and speed up the regexp search.
     */
    fast?: string
...
declare abstract class Container_<Child extends Node = ChildNode> extends Node {
  /**
   * An array containing the containerвЂ™s children.
   *
   * ```js
  ...
  /**
   * Iterates through the containerвЂ™s immediate children,
   * calling `callback` for each child.
   *
   * Returning `false` in the callback will break iteration.
   *
   * This method only iterates through the containerвЂ™s immediate children.
   * If you need to recursively iterate through all the containerвЂ™s descendant
   ...
   * for all of the containerвЂ™s children.
   *
   * ```js
  ...
  /**
   * Returns a `child`вЂ™s index within the `Container#nodes` array.
   *
   * ```js
   ...
   *
   * @param oldNode Child or childвЂ™s index.
  ...
  /**
   * Traverses the containerвЂ™s descendant nodes, calling callback
   ...
   * ```
   *
   * @param child Child or childвЂ™s index.
   * @return This node for methods chain.
   */
   ...
   *
   * If you only need to iterate through the containerвЂ™s immediate children,
   * use `Container#each`.
   *
   * ```js
   * root.walk(node => {
