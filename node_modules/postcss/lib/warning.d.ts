...
/**
 * Represents a pluginвЂ™s warning. It can be created using `Node#warn`.
 *
 * ```js
 * if (decl.important) {
...
declare class Warning_ {
  /**
   * Column for inclusive start position in the input file with this warningвЂ™s source.
   *
   * ```js
   * warning.column //=> 6
   * ```
  ...
  /**
   * Column for exclusive end position in the input file with this warningвЂ™s source.
   *
   * ```js
   * warning.endColumn //=> 4
   * ```
  ...
  /**
   * Line for exclusive end position in the input file with this warningвЂ™s source.
   *
   * ```js
   * warning.endLine //=> 6
   * ```
  ...
  /**
   * Line for inclusive start position in the input file with this warningвЂ™s source.
   *
   * ```js
   * warning.line //=> 5
   * ```
