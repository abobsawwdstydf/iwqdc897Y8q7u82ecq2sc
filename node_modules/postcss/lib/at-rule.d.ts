...
declare namespace AtRule {
  export interface AtRuleRaws extends Record<string, unknown> {
    ...
    /**
     * The ruleвЂ™s selector with comments.
     */
    params?: {
      raw: string
      value: string
 ...
 * ```
 *
 * If itвЂ™s followed in the CSS by a `{}` block, this node will have
...
declare class AtRule_ extends Container {
  /**
   * An array containing the layerвЂ™s children.
   *
   * ```js
  ...
  type: 'atrule'
  /**
   * The at-ruleвЂ™s name immediately follows the `@`.
   *
   * ```js
  ...
  /**
   * The at-ruleвЂ™s parameters, the values that follow the at-ruleвЂ™s name
