 ...
 * //         в”Њв”Ђв”Ђв”Ђ a tuple of effects
 * //         в–ј
 ...
 * ] as const
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<[number, string], never, never>
 * //      в–ј
 ...
 * )
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<number[], never, never>
 * //      в–ј
 ...
 * }
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<{ a: number; b: string; }, never, never>
 * //      в–ј
 ...
 * }
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<{ [x: string]: number; }, never, never>
 * //      в–ј
 ...
 * import { Effect } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<[string[], number[]], never, never>
 * //      в–ј
 ...
 * import { Effect, Console } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<number[], [string, ...string[]], never>
 * //      в–ј
 ...
 * import { Effect, Console } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<number, string[], never>
 * //      в–ј
 ...
 *   })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<Buffer, Error, never>
 * //      в–ј
 ...
 * import { Effect } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<never, Error, never>
 * //      в–ј
 ...
 *   )
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, never, never>
 * //      в–ј
 ...
 *   })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<void, never, never>
 * //      в–ј
 ...
 * }
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, HttpError | ValidationError, never>
 * //      в–ј
 * const program = Effect.gen(function* () {
 ...
 * })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, ValidationError, never>
 * //      в–ј
 * const recovered = program.pipe(
 *   Effect.catchIf(
 ...
 * import { Effect, Console } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, Error, never>
 * //      в–ј
 * const task = Effect.fail(new Error("Oh uh!")).pipe(
 *   Effect.as("primary result")
 * )
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, Cause<Error>, never>
 * //      в–ј
 ...
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<any, UnknownException, never>
 * //      в–ј
 * const program = parse("")
 *
 * ```
 ...
 *   })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<any, Error, never>
 * //      в–ј
 * const program = parse("")
 * ```
 *
 ...
 *   )
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<Response, UnknownException, never>
 * //      в–ј
 ...
 *   })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<Response, Error, never>
 * //      в–ј
 * const program = getTodo(1)
 * ```
 *
 ...
 * const program = Effect.fail("Oh uh!").pipe(Effect.as(2))
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, number, never>
 * //      в–ј
 ...
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<boolean, Error, never>
 * //      в–ј
 ...
 * const simulatedTask = Effect.fail("Oh no!").pipe(Effect.as(1))
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<number, Error, never>
 * //      в–ј
 ...
 * //
 * //      в”Њв”Ђв”Ђв”Ђ Effect<MyResource, Error, Scope>
 * //      в–ј
 ...
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<void, Error, never>
 * //      в–ј
 ...
 * import { Effect, Console } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, never, Scope>
 * //      в–ј
 * const program = Effect.gen(function* () {
 ...
 * import { Effect, Console } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<never, string, Scope>
 * //      в–ј
 * const program = Effect.gen(function* () {
 *   yield* Effect.addFinalizer((exit) =>
 *     Console.log(`Finalizer executed. Exit status: ${exit._tag}`)
 ...
 * // Wrapping the effect in a scope
 * //
 * //      в”Њв”Ђв”Ђв”Ђ Effect<never, string, never>
 * //      в–ј
 * const runnable = Effect.scoped(program)
 *
 * Effect.runPromiseExit(runnable).then(console.log)
 ...
 * import { Effect, Console } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<never, never, Scope>
 * //      в–ј
 * const program = Effect.gen(function* () {
 *   yield* Effect.addFinalizer((exit) =>
 *     Console.log(`Finalizer executed. Exit status: ${exit._tag}`)
 ...
 * // Wrapping the effect in a scope
 * //
 * //      в”Њв”Ђв”Ђв”Ђ Effect<never, never, never>
 * //      в–ј
 * const runnable = Effect.scoped(program)
 *
 * Effect.runPromiseExit(runnable).then(console.log)
 ...
 *
 * **Example** (Running a Cleanup Function with the EffectвЂ™s Result)
 *
 * ```ts
 ...
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<RuntimeFiber<number, never>, never, never>
 * //      в–ј
 ...
 *
 * Fibers created with this function are isolated from the parent fiberвЂ™s
 ...
 * )
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<void, never, Scope>
 * //      в–ј
 * const parent = Effect.gen(function* () {
 *   console.log("parent: started!")
 ...
 * })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<string, never, Service2>
 * //      в–ј
 ...
 * )
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<unknown[], never, Database>
 * //      в–ј
 * const program = Effect.gen(function*() {
 ...
 * })
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<unknown[], never, never>
 * //      в–ј
 ...
 * //      в–ј
 * const recovered = Effect.gen(function* () {
 *   //      в”Њв”Ђв”Ђв”Ђ Either<string, HttpError | ValidationError>
 *   //      в–ј
 ...
 *
 * The `Effect.raceFirst` function safely interrupts the вЂњloserвЂќ effect once the other completes, but it will not resume until the loser is cleanly terminated.
 *
 ...
 * **Details**
 *
 * This function runs two effects concurrently and calls a specified вЂњfinisherвЂќ
 ...
 * )
 *
 * //      в”Њв”Ђв”Ђв”Ђ RuntimeFiber<number, never>
 * //      в–ј
 ...
 * import { Effect } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<number, NoSuchElementException, never>
 * //      в–ј
 ...
 * ItвЂ™s ideal for scenarios where you want to explicitly represent optionality
 ...
 * const maybe1 = Effect.fromNullable(1)
 *
 * //      в”Њв”Ђв”Ђв”Ђ Effect<Option<number>, never, never>
 * //      в–ј
 ...
 * import { Effect, Option } from "effect"
 *
 * //      в”Њв”Ђв”Ђв”Ђ Option<Effect<number, never, never>>
 * //      в–ј
