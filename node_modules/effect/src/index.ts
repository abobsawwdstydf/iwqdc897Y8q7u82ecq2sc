 ...
 * (such as 0.1 + 0.2 в‰  0.3) at the cost of complexity.
 *
 ...
 * | operations   | {@link module:HashSet.intersection} | Computes set intersection (A в€© B)           | O(n)       |
 * | operations   | {@link module:HashSet.union}        | Computes set union (A в€Є B)                  | O(n)       |
 * |              |                                     |                                             |            |
