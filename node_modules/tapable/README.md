...
- Basic hook (without вЂњWaterfallвЂќ, вЂњBailвЂќ or вЂњLoopвЂќ in its name). This hook simply calls every function it tapped in a row.
...
Additionally, hooks can be synchronous or asynchronous. To reflect this, thereвЂ™re вЂњSyncвЂќ, вЂњAsyncSeriesвЂќ, and вЂњAsyncParallelвЂќ hook classes:
...
The hook type is reflected in its class name. E.g., `AsyncSeriesWaterfallHook` allows asynchronous functions and runs them in series, passing each functionвЂ™s return value into the next function.
