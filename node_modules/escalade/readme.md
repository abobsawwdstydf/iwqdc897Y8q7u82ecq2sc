...
> **Important:**<br>Please note that `escalade` only deals with direct ancestry вЂ“ it will not dive into parents' sibling directories.
...
# Levels: 6 (target = "foo.txt"):
  find-up          x 24,856 ops/sec В±6.46% (55 runs sampled)
  escalade         x 73,084 ops/sec В±4.23% (73 runs sampled)
  find-up.sync     x  3,663 ops/sec В±1.12% (83 runs sampled)
  escalade/sync    x  9,360 ops/sec В±0.62% (88 runs sampled)

# Levels: 12 (target = "package.json"):
  find-up          x 29,300 ops/sec В±10.68% (70 runs sampled)
  escalade         x 73,685 ops/sec В± 5.66% (66 runs sampled)
  find-up.sync     x  1,707 ops/sec В± 0.58% (91 runs sampled)
  escalade/sync    x  4,667 ops/sec В± 0.68% (94 runs sampled)

# Levels: 18 (target = "missing123.txt"):
  find-up          x 21,818 ops/sec В±17.37% (14 runs sampled)
  escalade         x 67,101 ops/sec В±21.60% (20 runs sampled)
  find-up.sync     x  1,037 ops/sec В± 2.86% (88 runs sampled)
  escalade/sync    x  1,248 ops/sec В± 0.50% (93 runs sampled)
```
...
MIT В© [Luke Edwards](https://lukeed.com)
