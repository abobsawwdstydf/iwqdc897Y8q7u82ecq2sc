...
(Keep using JSON or other file formats for that. рџ™‚)
...
implementation of JSON5 was also modeled directly off of DougвЂ™s open-source
[json_parse.js] parser. WeвЂ™re grateful for that clean and well-documented
code.
