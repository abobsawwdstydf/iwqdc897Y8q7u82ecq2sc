...
uuidv4(); // в‡Ё '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d'
```
...
uuidv4(); // в‡Ё '1b9d6bcd-bbfd-4b2d-9b5d-ab8dfbbd4bed'
```
...
NIL_UUID; // в‡Ё '00000000-0000-0000-0000-000000000000'
```
...
MAX_UUID; // в‡Ё 'ffffffff-ffff-ffff-ffff-ffffffffffff'
```
...
// Parse a UUID
uuidParse('6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'); // в‡Ё
// Uint8Array(16) [
//   110, 192, 189, 127,  17,
//   192,  67, 218, 151,  94,
//    42, 138, 217, 235, 174,
...
uuidStringify(uuidBytes); // в‡Ё '6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'
```
...
uuidv1(); // в‡Ё '2c5ea4c0-4067-11e9-9bdd-2b0d7b3dcb6d'
```
...
uuidv1(options); // в‡Ё '710b962e-041c-11e1-9234-0123456789ab'
```
...
v1ToV6('92f62d9e-22c4-11ef-97e9-325096b39f47'); // в‡Ё '1ef22c49-2f62-6d9e-97e9-325096b39f47'
```
...
uuidv4(v4options); // в‡Ё '109156be-c4fb-41ea-b1b4-efe1671c5836'
```
...
uuidv5('Hello, World!', MY_NAMESPACE); // в‡Ё '630eb68f-e0fa-5ecc-887a-7c7a62614681'
```
...
uuidv5('https://www.w3.org/', uuidv5.URL); // в‡Ё 'c106a26a-21bb-5538-8bf2-57095d1976c1'
```
...
uuidv6(); // в‡Ё '1e940672-c5ea-64c0-9b5d-ab8dfbbd4bed'
```
...
uuidv6(options); // в‡Ё '1e1041c7-10b9-662e-9234-0123456789ab'
```
...
v6ToV1('1ef22c49-2f62-6d9e-97e9-325096b39f47'); // в‡Ё '92f62d9e-22c4-11ef-97e9-325096b39f47'
```
...
uuidv7(); // в‡Ё '01695553-c90c-705a-b56d-778dfbbd4bed'
```
...
uuidValidate('not a UUID'); // в‡Ё false
uuidValidate('6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'); // в‡Ё true
```
...
uuidValidateV4(v4Uuid); // в‡Ё true
uuidValidateV4(v1Uuid); // в‡Ё false
```
...
uuidVersion('45637ec4-c85f-11ea-87d0-0242ac130003'); // в‡Ё 1
uuidVersion('6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'); // в‡Ё 4
```
