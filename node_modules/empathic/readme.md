...
* **fast** вЂ” 8x to 40x faster than popular alternatives
* **modern** вЂ” based on newer `node:*` native APIs
* **small** вЂ” ranging from 200b to 500b in size
* **safe** вЂ” zero-dependency & easy to read
...
> [Source](/src/access.ts) В· **Size:** `259b`
...
> [Source](/src/find.ts) В· [Benchmark](/benchmarks.md#find) В· **Size:** `569b`

Find files and/or directories by walking up parent directories.

### `empathic/package`

> [Source](/src/package.ts) В· [Benchmark](/benchmarks.md#package) В· **Size:** `505b`

Convenience helpers for dealing with `package.json` files and/or `node_modules` packages.

### `empathic/resolve`

> [Source](/src/resolve.ts) В· [Benchmark](/benchmarks.md#resolve) В· **Size:** `419b`

Resolve absolute paths to package identifiers, relative paths, file URL, and/or from other root directories.

### `empathic/walk`

> [Source](/src/walk.ts) В· [Benchmark](/benchmarks.md#walk) В· **Size:** `208b`
