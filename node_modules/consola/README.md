...
рџ‘Њ&nbsp; Easy to use<br>
рџ’…&nbsp; Fancy output with fallback for minimal environments<br>
рџ”Њ&nbsp; Pluggable reporters<br>
рџ’»&nbsp; Consistent command line interface (CLI) experience<br>
рџЏ·&nbsp; Tag support<br>
рџљЏ&nbsp; Redirect `console` and `stdout/stderr` to consola and easily restore redirect.<br>
рџЊђ&nbsp; Browser support<br>
вЏЇ&nbsp; Pause/Resume support<br>
рџ‘»&nbsp; Mocking support<br>
рџ‘®вЂЌв™‚пёЏ&nbsp; Spam prevention by throttling logs<br>
вќЇ&nbsp; Interactive prompt support powered by [`clack`](https://github.com/natemoo-re/clack)<br>
